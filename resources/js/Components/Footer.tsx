            ...
            <footer className="z-10 px-6 py-16 text-sm text-center text-black dark:text-white/70">
                <div className="flex flex-col items-center justify-center w-full mx-auto sm:w-2/3">
                    ...
                    <p className="mt-4 text-sm text-center text-white">
                        ...
                        <span className="text-[#FF9DB7] font-bold pr-1">
                            Μικρούς
                        </span>
                        <span className="text-[#78D3EF] font-bold">
                            Μαθητές
                        </span>
                        , μέσα από παιχνίδια, τραγούδια και φανταστικές
                        περιπέτειες! Με κάθε βήμα μαθαίνουμε, δημιουργούμε και
                        χτίζουμε τη δική μας ζωή γεμάτη χρώματα, ιδέες και
                        όνειρα!
                    </p>
