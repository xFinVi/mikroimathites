  ...
  const promotionalVideo = [
    {
      ...
      snippet: {
        title:
          "Χριστούγεννα με την Κυρία Βικτωρία και τον Μπρούνο : Τραγούδια Μπισκότα και Χαμένα Δώρα",
      },
    },
    {
      id: "9z7R4nYWMME32",
      snippet: {
        title:
          "Μαθαίνω Τα Φρούτα με την Βικτωρία | Εκπαιδευτικά Βίντεο | Παιδικά Τραγούδια - Greek Nursery Rhymes",
      },
    },
  ];
